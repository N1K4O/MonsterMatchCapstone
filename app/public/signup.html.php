...
<body>
    <nav class="navbar navbar-dark navbar-expand-md sticky-top border-secondary shadow navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span
                    ...
                    </svg></span><span>Monster Match</span></a><button data-bs-toggle="collapse" class="navbar-toggler"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><a class="btn btn-outline-warning shadow" role="button" href="signup.html.php">Sign up</a><a
                    class="btn btn-outline-warning" role="button" href="login.html.php">Login</a>
            </div>
        </div>
    </nav>
    <section class="py-5">
