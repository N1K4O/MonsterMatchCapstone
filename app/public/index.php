...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;">
    <nav id="mainNav" class="navbar navbar-dark navbar-expand-md sticky-top border-secondary shadow navbar-shrink py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="btn btn-outline-warning">Home</span></a><button class="navbar-toggler" data-bs-toggle="collapse"
            ...
            <ul class="navbar-nav mx-auto">
                <?php if (!isset($user)): ?>
                    ...
                    <li class="nav-item"></li>
                </ul><a class="btn btn-outline-warning shadow" role="button" href="login.html.php">Login</a> <a
                        class="btn btn-outline-warning" role="button" href="signup.html.php">Sign up</a>
                <?php else: ?>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <h1 class="display-2 fw-bold text-center">Welcome to <span style="color: rgb(4, 188, 44);">Monster</span><span style="color: rgb(239, 115, 0);">Match</span></h1>
                    </div>
                    <?php if (isset($user)):
                        $user_id = $user["id"];
